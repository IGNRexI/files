...
-- Lines 146-178
function OnGetMaxSpeed(fMaxSpeed, pWeapon)
	if pWeapon ~= nil then
		local pPlayer = pWeapon:GetPlayerOwner()

		if pPlayer ~= nil and EventManager:HasFlag(pPlayer.m_nButtons, IN_ATTACK) then
			return pWeapon:GetCSWpnData().m_flMaxSpeed
		end
	end
